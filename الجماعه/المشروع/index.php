    ...
    <div class="row">
          ...
          <div class="img-thumbnail item-box">
            ...
            <div class="caption">
              <h4 class="desc" style="margin: 5px">
                <a class="title" href="view.php?product_id=<?php echo $row['id'] ?>"><?php echo $row['name'] . ' ' . date_default_timezone_get() ?></a>
              </h4>
      ...
      <div class="col-6 col-md-3">
        <div class="img-thumbnail item-box">
          ...
          <div class="caption">
            <h4 class="desc" style="margin: 5px">
              <a class="title" href="view.php">annskfksjgkj <?php echo date_default_timezone_get() ?></a>
            </h4>
